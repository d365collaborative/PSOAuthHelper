Describe "Get-BearerToken Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-BearerToken).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter AuthProviderUri' {
			$parameter = (Get-Command Get-BearerToken).Parameters['AuthProviderUri']
		...
		It 'Should have the expected parameter Resource' {
			$parameter = (Get-Command Get-BearerToken).Parameters['Resource']
		...
		It 'Should have the expected parameter GrantType' {
			$parameter = (Get-Command Get-BearerToken).Parameters['GrantType']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Get-BearerToken).Parameters['ClientId']
		...
		It 'Should have the expected parameter ClientSecret' {
			$parameter = (Get-Command Get-BearerToken).Parameters['ClientSecret']
		...
		It 'Should have the expected parameter Scope' {
			$parameter = (Get-Command Get-BearerToken).Parameters['Scope']
