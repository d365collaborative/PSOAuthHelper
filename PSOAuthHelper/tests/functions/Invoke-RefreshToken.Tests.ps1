Describe "Invoke-RefreshToken Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-RefreshToken).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -AuthProviderUri
		__AllParameterSets -AuthProviderUri -ClientId -RefreshToken
		#>
	}
