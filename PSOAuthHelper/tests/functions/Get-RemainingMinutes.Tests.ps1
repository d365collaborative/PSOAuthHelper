Describe "Get-RemainingMinutes Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-RemainingMinutes).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter InputObject' {
			$parameter = (Get-Command Get-RemainingMinutes).Parameters['InputObject']
