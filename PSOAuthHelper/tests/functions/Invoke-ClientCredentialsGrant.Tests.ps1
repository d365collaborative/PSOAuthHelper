Describe "Invoke-ClientCredentialsGrant Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-ClientCredentialsGrant).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -AuthProviderUri -Resource -ClientId -ClientSecret
		__AllParameterSets -AuthProviderUri -Resource -ClientId -ClientSecret -Scope -EnableException
		#>
	}
